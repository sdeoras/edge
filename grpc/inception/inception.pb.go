...
/*
Package inception is a generated protocol buffer package.
...
type Ack struct {
	...
	TopLabel string   `protobuf:"bytes,2,opt,name=topLabel" json:"topLabel,omitempty"`
...
type Label struct {
	...
	Probability int64  `protobuf:"varint,2,opt,name=probability" json:"probability,omitempty"`
}
...
// Client API for Inception service
...
func (c *inceptionClient) Query(ctx context.Context, opts ...grpc.CallOption) (Inception_QueryClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Inception_serviceDesc.Streams[0], c.cc, "/inception.Inception/Query", opts...)
	if err != nil {
		return nil, err
	}
...
// Server API for Inception service
...
func init() { proto.RegisterFile("inception.proto", fileDescriptor0) }
